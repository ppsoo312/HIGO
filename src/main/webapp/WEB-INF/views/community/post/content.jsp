      ...
      <div class=" col-lg-9   mb-5 mb-lg-0">
        ...
        <div class="mt-5">
            <div class="mb-5 border-top mt-4 pt-5">
               ...
               <form action="${ pageContext.request.contextPath }/comment/writeComment?post_seq=${vo.post_seq}" method="post" name="writeComment">
               <div class="media d-block d-sm-flex mb-4 pb-4">
                  ...
                  <input type="text" name="comm_content" size="60">
                    <input class="btn btn-primary" type="button" value="댓글쓰기" onclick="checkWriteComment()">
                  </c:if>
                  </form>
                  <div align="center">
                  ...
                  <div class="media-body">
                    ...
                    <input type="button" class="commentContent" value="${cvo.comm_content }" onclick="commentComment(event,${i.index})">
                  </div>
               </div>
               <div class="media d-block d-sm-flex">
                  ...
                  <div class="media-body">
                     ...
                     <input type="text"  id="comm_content${i.index}" size="60">
                   <input type="button" value="댓댓걸!" onclick="checkWritecommentComment(${i.index},${cvo.comm_seq})">
                     </div>
                  </div>
					</div>
                  </c:forEach>
