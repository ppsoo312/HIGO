...
<!-- START Profile_wrap -->
<div class="container-md profile_wrap section align-items-center mt-5 mx-auto">
	...
	<form action="${ pageContext.request.contextPath }/gosu/gosuinfo" method="post" name="user_info" class="my-5">
		<div class="gosu-info row justify-content-between">
			...
			<div class="col-12 w-100 text-wrap">
				<input class="col-12 mb-5" type="text" id="name" value="${vo.name }" disabled="disabled">
			</div>
		</div>
	</form>

	<!-- 대표서비스 -->
	<form action="${ pageContext.request.contextPath }" method="post" class="my-5">
	...
	<form action="${ pageContext.request.contextPath }/gosu/intro" method="POST" id="introForm" class="my-5">
		<div class="row justify-content-between">
			...
			<div class="col-12 w-100 text-wrap">
				<input class="w-100 col-12 mb-5" type="text" id="reintro" value="${ intro }" disabled="disabled">
			</div>
		</div>
	</form>
	...
	<input type="hidden" id="km" name="km" value="" />
		<div class="row justify-content-between">
			...
			<div class="col-12 w-100">
				<input class="w-100 col-12 text-start mb-5" type="text" id="actaddr" value="${ actaddr }" disabled="disabled">
			</div>
		</div>
	...
	<!-- 서비스 범위 -->
		...
		<div class="row justify-content-between" class="my-5">
			...
			<div class="w-100 col-12">
				<input class="w-100 col-12 mb-3" type="text" id="active_range" value="${ svc_range }" disabled="disabled">
			</div>
